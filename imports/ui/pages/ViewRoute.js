...
import { removeRoute } from '../../api/routes/methods.js';


const handleRemove = (_id) => {
  if (confirm('Are you sure? This is permanent!')) {
    removeRoute.call({ _id }, (error) => {
      if (error) {
        Bert.alert(error.reason, 'danger');
      } else {
        Bert.alert('Route deleted!', 'success');
        browserHistory.push('/routes');
      }
    });
  }
  function myFunction() {
    var element = route.getElementById("myDIV");
...
const ViewRoute = ({ doc }) => !doc ? <div>This customer either doesn't exist or you don't have permission to see it</div> : (
  <div className="card ViewRoute">
    ...
    <div className="page-header clearfix">
      ...
      <ButtonToolbar className="pull-right">
        <ButtonGroup bsSize="small">
          <Button href={`/routes/${doc._id}/edit`}>
          ...
          <Button className="text-add" href={`/routes/new`}>
